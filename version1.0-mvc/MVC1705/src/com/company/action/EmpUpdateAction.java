...
/**
 * Servlet implementation class EmpUpdateAction
 */
@WebServlet("/EmpUpdateAction")
public class EmpUpdateAction extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (Response.SUCCESS.equals(msg)) {
			...
			session.setAttribute("errMsg", "更新失败");
